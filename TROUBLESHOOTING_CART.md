...
Oryginalna treść tego dokumentu została przeniesiona do `docs/archive/TROUBLESHOOTING_CART.md`.
...
Jeśli chcesz, mogę ponownie przywrócić pełną treść lub pozostawić kopię w archiwum na branchu `archive-cleanup`.
